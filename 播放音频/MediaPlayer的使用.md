...
![image-20220906155113719](MediaPlayer的使用.assets/image-20220906155113719.png)

![image-20220906155215301](MediaPlayer的使用.assets/image-20220906155215301.png)

```java
mediaPlayer = MediaPlayer.create(this,R.raw.tashanhe);//初始化
```

```java
getDuration();//获取播放最大长度
```

```java
getCurrentPosition();//获取实时播放进度
```
...
![image-20220906201521055](MediaPlayer的使用.assets/image-20220906201521055.png)